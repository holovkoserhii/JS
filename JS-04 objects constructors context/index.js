...
function Cashier(name, productsDatabase) {
  ...
  this.name = name,
  this.productsDatabase = productsDatabase, // ЧИ ПОТРІБНО??
  this.totalPrice = 0,
  this.customerMoney = 0,
  this.changeAmount = 0,
  this.greet = function() {
    console.log(`Hi, you've been serviced by ${this.name}`);
  },
  this.onSuccess = function() {
    this.changeAmount > 0 ? console.log(`Thanks, your change is ${this.changeAmount}`) : console.log('Thanks!');
  }
  this.onError = function() {
    console.log('Sorry, you don\'t have enough money to make a purchase!');
  }
